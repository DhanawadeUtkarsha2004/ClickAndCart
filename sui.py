...
def index():
        ...
        try:
            ...
            if file:
                ...
                if url:
                    ...
                    return render_template('sui.html', data=filtered_df.to_dict('records'),
    ...
    return render_template('sui.html', data=[])
...
if __name__ == '__main__':
    sui.run(debug=True, host='0.0.0.0', port=5001)
